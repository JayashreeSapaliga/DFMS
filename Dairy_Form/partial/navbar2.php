<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="cow_rate.php">
                            <i class="fas fa-file-alt"></i>
                                <span class="ml-2">Cow</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="buffalo_rate.php">
                            <i class="fas fa-file-alt"></i>
                                <span class="ml-2">Buffalo</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="daily_collection.php">
                            <i class="fas fa-book"></i>
                                <span class="ml-2">Daily Collection</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="allcustomerbill.php">
                            <i class="fas fa-sticky-note"></i>
                                <span class="ml-2">Customer Bill</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="singleCustomerbill.php">
                            <i class="fas fa-sticky-note"></i>
                                <span class="ml-2">Single Customer Bill</span>
                            </a>
                        </li>
